        ...
        <form action="<?php echo base_url()?>pages/checkout" method="post">
          <div class="row mt-4 p-3">
            ...
            <div class="col-md-6">
              ...
              <input type="number" min="1" step="1" class="form-control mt-2" name="sendinputbox" id="sendinputbox" placeholder="Enter the Send Amount" required>
              <input type="text" name="sendIsDollar" id="sendIsDollar">
              <input type="text" name="sendbuyrate" id="sendbuyrate">
              <input type="text" name="sendsellrate" id="sendsellrate">
              <input type="text" name="sendprocessingfee" id="sendprocessingfee">
            ...
            <div class="col-md-6">
              ...
              <input type="number" class="form-control mt-2" name="receiveinputbox" id="receiveinputbox" readonly>
              <input type="text" name="receiveIsDollar" id="receiveIsDollar">
              <input type="text" name="receivebuyrate" id="receivebuyrate">
              <input type="text" name="receivesellrate" id="receivesellrate">
              <input type="text" name="receiveprocessingfee" id="receiveprocessingfee">
              <!-- Below part is for Calculation -->
  ...
  function sendChange(id){
	...
	$.ajax({
	  ...
	  success:function(response){
	    var path = response.icon;
	    var img = base_url+path;
